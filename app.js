window.addEventListener('load', function () {
  ...
  const larva = new Image()
  larva.src = 'images/larva.png'
  const obstacles = new Image()
  obstacles.src = 'images/obstacles.png'
  const overlay = new Image()
  overlay.src = 'images/overlay.png'
  const toad = new Image()
  toad.src = 'images/toad.png'
  const toads = new Image()
  toads.src = 'images/toads.png'
